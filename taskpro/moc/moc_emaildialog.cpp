...
**
** Created: Mon Jun 6 20:47:21 2011
...
static const char qt_meta_stringdata_EmailDialog[] = {
    "EmailDialog\0"
};

const QMetaObject EmailDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EmailDialog,
      qt_meta_data_EmailDialog, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EmailDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EmailDialog))
        return static_cast<void*>(const_cast< EmailDialog*>(this));
